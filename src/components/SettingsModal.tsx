...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const renderGeneralTab = () => (
    <div className="py-4 grid grid-cols-[140px_1fr] gap-4 items-center">
      ...
      />
      <div className="col-span-2 text-xs text-gray-500 mb-2">
        Guides the speech recognition to better understand specific words or
        context.
      </div>
      ...
      />
      <div className="col-span-2 text-xs text-gray-500 mb-2">
        ⚠ Caution: Incorrect arguments may prevent the server from starting.
        Check whisper-server --help.
      </div>
